...
int main (int argc, char *argv[]){
    if(argc<4){
        cerr<<"Error! Usage of the program: "<<argv[0]<<" <input_dir> <input.dat> <y/n> (if you want or not XYZ format) "<<endl;
        return -1;
    }
    int nconf = 1;
    bool xyz = false;
    if(strcmp(argv[3],"y") == 0) xyz = true;
    System SYS;
    SYS.initialize(argv[1],"../OUTPUT","../../Librerie/Random Generator",argv[2]);
