...
int main (int argc, char** argv) {
    ...
    for(int i=0;i<N;i++){
        ...
        double err= e/sqrt(2*sqrt(t2));     //il numeratore è la semplice definizione di var mentre il denominatore è dato dalla propagazione degli errori per ottenere l'incertezza su √<r^2>
        fout<<t2<<"\t"<<e<<endl;
        t2=0; t4=0;
    }
